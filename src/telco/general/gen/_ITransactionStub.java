...
public class _ITransactionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements telco.general.gen.ITransaction
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = telco.general.gen.ITransactionOperations.class;
	public void rollback() throws org.omg.CosTransactions.HeuristicHazard,org.omg.CosTransactions.HeuristicMixed,org.omg.CosTransactions.HeuristicCommit
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			ITransactionOperations _localServant = (ITransactionOperations)_so.servant;
			try
			{
	...
	public void useMessage(telco.general.gen.Message m)
	{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "useMessage", _opsClass );
			if( _so == null )
				continue;
			ITransactionOperations _localServant = (ITransactionOperations)_so.servant;
			try
			{
				_localServant.useMessage(m);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void useMessageExplicit(telco.general.gen.Message m, org.omg.CosTransactions.Control control_)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "useMessageExplicit", true);
					telco.general.gen.MessageHelper.write(_os,m);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "useMessageExplicit", _opsClass );
			if( _so == null )
				continue;
			ITransactionOperations _localServant = (ITransactionOperations)_so.servant;
			try
			{
				_localServant.useMessageExplicit(m,control_);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
